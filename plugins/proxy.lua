...
local function pre_process(msg)
  ...
  if (msg.to.type == 'user' and string.match(msg.from.username,nocase("bot$")) == nil and msg.from.username ~='wrxck' and msg.from.id ~= 0 and msg.from.id ~= our_id and string.match(msg.text,"^[!/#]") == nil) then
